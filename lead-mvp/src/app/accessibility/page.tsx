...
export default function AccessibilityPage() {
  return <main id="main" className="shell legal-shell"><h1>הצהרת נגישות</h1><p className="legal-intro">עודכן לאחרונה: 30 באוגוסט 2026.</p>
    ...
    <section className="legal-section"><h2>רכז נגישות ופנייה בנושא נגישות</h2><p>רכז הנגישות: {site.accessibilityCoordinator}.</p><p>טלפון: {site.phone || 'יושלם לפני העלייה לאוויר'}.</p><p>אימייל: {site.email || 'יושלם לפני העלייה לאוויר'}.</p><p>אם נתקלתם בקושי בשימוש באתר, נשמח לקבל פירוט של העמוד, הפעולה שניסיתם לבצע והטכנולוגיה המסייעת שבה השתמשתם, ככל שרלוונטי.</p></section>
  </main>
}
