...
export default function PrivacyPage() {
  return <main id="main" className="shell legal-shell"><h1>מדיניות פרטיות</h1><p className="legal-intro">עודכן לאחרונה: 30 באוגוסט 2026. מדיניות זו מתייחסת לאתר הלידים והבדיקה הראשונית בלבד.</p>
    <section className="legal-section"><h2>איזה מידע נאסף</h2><p>במהלך הבדיקה עשויים להימסר טווח גיל, מעמד אזרחי או תושבות, סוג שירות ללא סיבת פטור רפואית, שם יישוב וקבוצות תבחין שסומנו. אם בוחרים להשאיר פנייה, נאספים גם שם מלא, טלפון, כתובת אימייל והערה חופשית, אם נכתבה.</p></section>
    ...
    <section className="legal-section"><h2>מדידת שימוש אנונימית</h2><p>האתר משתמש ב־Vercel Web Analytics לצורך מדידת צפיות ואירועי שימוש כגון התחלת הסינון, השלמת שלב, השלמת הסינון ושליחת ליד. לא נשלחים באירועים שם, טלפון, אימייל, יישוב או תשובות התבחין; אירועי הסינון כוללים לכל היותר מספר שלב או צבע תוצאה. לפי מסמכי Vercel, השירות אינו משתמש בקובצי Cookie לצורך Web Analytics ושומר נתונים מצרפיים ואנונימיים.</p></section>
