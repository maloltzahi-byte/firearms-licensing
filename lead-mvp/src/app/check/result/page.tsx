...
const states = {
  ...
  yellow: { label:'צהוב', title:'ייתכן שקיים מסלול — נדרשת בדיקה פרטנית', text:'לפי התשובות שמסרת ייתכן שקיים מסלול מתאים, אך נדרש בירור פרטני לפני שמתקדמים. אפשר להמשיך ישירות לשיחה עם עורך דין.' },
...
export default function ResultPage() {
  ...
  return <>
    ...
    <main id="main" className="result-content">
      ...
      <h2 className="result-cta-heading">רוצים שאבדוק את המקרה שלכם?</h2>
